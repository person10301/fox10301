  ...
  <div class="button-container">
    ...
    <a href="https://4pda.to/forum/index.php?showuser=9050872" class="button">
      <svg class="custom-icon" width="24" height="24" viewBox="0 0 108 108" xmlns="http://www.w3.org/2000/svg">
        <path fill="#00FF7F" d="m54 25a29 29 0 1 0 29 29 29 29 0 0 0-29-29zm13.69 45.92h-11.69l-.08-6.4h-20.45v-10l15.33-17.44h16.89z"/>
        <path fill="#00FF7F" d="m47.16 56.6 8.59.01v-9.56z"/>
      </svg>
    </a>
